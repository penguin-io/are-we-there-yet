...
class Layout extends React.Component {
  ...
  render() {
    ...
    const images = importAll(require.context('../templates/snapshot/images', false, /\.(png|jpe?g|svg)$/));
    ...
    return (
      <div id="main">
		...
		<section id="home" class="hero-wrap js-fullheight" style={{backgroundImage : 'url(' + images[3] + ')'}} data-stellar-background-ratio="0.5">
      ...
      <div class="container">
    		...
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img img-video d-flex align-self-stretch align-items-center" style={{backgroundImage: 'url(' + images[0] + ')'}}>
	          ...
	          <div class="heading-section ftco-animate">
	            ...
	            <div class="counter-wrap ftco-animate d-flex my-md-4">
		          ...
		          <div class="d-flex w-100">
		            <div class="img img-about-2 mr-2" style={{backgroundImage: 'url(' + images[2] + ')'}}></div>
		            <div class="img img-about-2 ml-2" style={{backgroundImage: 'url(' + images[1] + ')'}}></div>
		          </div>
		...
		<section id="services" class="ftco-section">
		  <div class="container">
	        ...
	        <div class="col-md-3 d-flex align-items-stretch">
	        	<div class="img w-100" style={{backgroundImage: 'url(' + images[2] + ')'}}></div>
	        </div>
        </div>
        <div class="row progress-circle pt-md-5">
        	<div class="col-md-7 order-md-last py-md-5">
	        	...
	        	<div class="img w-100" style={{backgroundImage: 'url(images/about-2.jpg)'}}></div>
	        </div>
		  	</div>
		  </div>
		</section>  
        ...
        <div class="row no-gutters">
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-1.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-2.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-3.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-4.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-5.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-6.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-7.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-8.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-9.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-10.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-11.jpg)'}}>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style={{backgroundImage: 'url(images/model-12.jpg)'}}>
